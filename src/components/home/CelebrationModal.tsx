        ...
        <div className="w-full flex-1 flex flex-col">
          ...
          <div className="flex items-center justify-between mt-8 pt-6 border-t border-[#E5E0D8]">
            ...
            <div className="flex gap-4">
              <button
                onClick={() => alert("We'll wire up the ReadingTracksModal here soon!")}
                className="bg-transparent border border-[#424B2E] text-[#424B2E] font-sans text-sm font-medium tracking-wide px-6 py-2.5 rounded hover:bg-[#EFEBE1] transition"
              >
                Assign Follow-up
              </button>
              <button
