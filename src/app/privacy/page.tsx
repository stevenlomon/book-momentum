...
export default function PrivacyPage() {
  return (
    <div className="min-h-screen py-16 px-8 flex justify-center">
      <div className="w-full max-w-3xl">
        <header className="mb-12 border-b border-[#E5E0D8] pb-6">
          <h1 className="text-4xl font-heading text-[#2C302E] mb-3">Privacy</h1>
          <p className="text-[#5C613E] font-serif text-lg italic">
            A sanctuary means nothing if the walls are made of glass.
          </p>
        </header>

        <article className="space-y-10 text-[#2C302E] font-serif leading-relaxed">
